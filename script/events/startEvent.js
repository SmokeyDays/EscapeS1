var startEvent = {
	...
	'mid-end-1': {
		id: "mid-end-1",
		title: "独自跑路",
		desc: "你成功逃出了南一，但你和你的朋友们的包还在里头。你觉得自己有必要想个办法把包弄出来。",
		...
		optionList: [
			{
				...
				id: "try-pass",
				title: "重回走廊",
				desc: "你看到手机上你的朋友说走廊似乎又可以通行了。你决定通过走廊取回包。",
				logs: "你从花园重新回到那个有栏杆的走廊。",
				eventList: [
					'be-2'
				]
			},{
	...
	'end-1': {
		id: "end-1",
		title: "结局一：速通南一",
		desc: "由于封锁突然，人员还未就位，后方的人追了你一段路后放弃了。你成功赶在封锁前逃离了南一，抢购物资，回到寝室，有点后悔刚才武断的决定。然后，两个小时过去了，你得知了阳伪的消息。南一解封了。平安无事。",
	},
	'end-2': {
		id: "end-2",
		title: "结局二：单人冒险",
	...
	'be-1': {
		id: "be-1",
		title: "寄局一：莽夫终局",
		desc: "你尝试冲出去，然而，已经完全封锁的南一楼织成了紧密的罗网。你被抓住了。由于你对抗防疫，你被关在那里狠狠的批评了一通，并且面临处分的结果。所幸，南一阳伪，没有酿成大祸。",
	},
	'be-2': {
		id: "be-2",
		title: "寄局二：重投罗网",
		desc: "你回到了南一的花园，却发现花园里埋伏着一个人！你被抓了现行，带到了一个不知名的地方。你费劲口舌说明了你只是为了帮朋友取电脑，但仍未能脱身。这时，此前见过你的初次尝试的守卫走了过来……所幸，南一解封，虚惊一场，你没有酿成大祸。",
	},
	'findDrink': {
		id: "findDrink",
		title: "试图解渴",
